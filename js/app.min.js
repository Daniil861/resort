...
const search_main_in = document.querySelector('.main__input_in');
const search_main_out = document.querySelector('.main__input_out');
const search_main_guests = document.querySelector('.main__input_guests');

search_main_in.onkeypress = (e) => {
	if (e.keyCode < 46 || e.keyCode > 57 || e.keyCode == 47) {
		search_main_in.value += '';
	} else {
		search_main_in.value += e.key;
	}
	return false;
};
search_main_out.onkeypress = (e) => {
	if (e.keyCode < 46 || e.keyCode > 57 || e.keyCode == 47) {
		search_main_out.value += '';
	} else {
		search_main_out.value += e.key;
	}
	return false;
};
search_main_guests.onkeypress = (e) => {
	if (e.keyCode < 46 || e.keyCode > 57 || e.keyCode == 47) {
		search_main_guests.value += '';
	} else {
		search_main_guests.value += e.key;
	}
	return false;
};
